...
spl_autoload_register(function($className) {
    ...
    if (!is_array($map)) {
        $map = array(
			'application\\entity\\BasePageEntity' => __DIR__ . '/application/entity/BasePageEntity.php',
			'application\\entity\\GalleryFeedEntity' => __DIR__ . '/application/entity/GalleryFeedEntity.php',
			'application\\entity\\GalleryItemPageEntity' => __DIR__ . '/application/entity/GalleryItemPageEntity.php',
			'application\\entity\\GalleryPageEntity' => __DIR__ . '/application/entity/GalleryPageEntity.php',
			'application\\entity\\HeroPageEntity' => __DIR__ . '/application/entity/HeroPageEntity.php',
			'application\\entity\\HeroVideoPageEntity' => __DIR__ . '/application/entity/HeroVideoPageEntity.php',
			'application\\entity\\MainPageEntity' => __DIR__ . '/application/entity/MainPageEntity.php',
			'application\\entity\\NotFoundPageEntity' => __DIR__ . '/application/entity/NotFoundPageEntity.php',
			'application\\entity\\SectionPageEntity' => __DIR__ . '/application/entity/SectionPageEntity.php',
			'application\\entity\\SiteMapEntity' => __DIR__ . '/application/entity/SiteMapEntity.php',
			'application\\entity\\SiteMapPageEntity' => __DIR__ . '/application/entity/SiteMapPageEntity.php',
			'application\\entity\\StandardPageEntity' => __DIR__ . '/application/entity/StandardPageEntity.php',
			'application\\entity\\VideoPageEntity' => __DIR__ . '/application/entity/VideoPageEntity.php',
			'application\\environment\\DevelopmentEnvironment' => __DIR__ . '/application/environment/DevelopmentEnvironment.php',
			'application\\environment\\PreviewEnvironment' => __DIR__ . '/application/environment/PreviewEnvironment.php',
			'application\\environment\\ProductionEnvironment' => __DIR__ . '/application/environment/ProductionEnvironment.php',
			'application\\Environment' => __DIR__ . '/application/Environment.php',
			'application\\FrontendApplication' => __DIR__ . '/application/FrontendApplication.php',
			'application\\locale\\Locale' => __DIR__ . '/application/locale/Locale.php',
			'application\\locale\\LocaleRouter' => __DIR__ . '/application/locale/LocaleRouter.php',
			'application\\recourse\\LanguageDetectionResource' => __DIR__ . '/application/resource/LanguageDetectionResource.php',
			...
			'core\\geo\\GeoIPStore' => __DIR__ . '/core/geo/GeoIPStore.php',
